...
export const USER_PLAYER_PREFS_SET = 'server/USER_PLAYER_PREFS_SET'
export const USER_PLAYER_PREFS_PUSH = 'prefs/USER_PLAYER_PREFS_PUSH'
...
export const PREFS_PATH_SET_MANAGER = 'prefs/PREFS_PATH_SET_MANAGER'
...
export const LRC_ENHANCE_QUEUE = 'scannerWorker/LRC_ENHANCE_QUEUE'
export const LRC_ENHANCE_STATUS = 'scannerWorker/LRC_ENHANCE_STATUS'
export const MB_TAG_QUEUE = 'scannerWorker/MB_TAG_QUEUE'
export const MB_TAG_STATUS = 'scannerWorker/MB_TAG_STATUS'
